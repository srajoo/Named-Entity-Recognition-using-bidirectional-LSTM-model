...
create_op_file(x_lstm_dev, y_lstm_dev, model, dev_set, "output/dev_task_1.out", pad_idx, False)
print("Complete!")
...
create_op_file(x_lstm_test, None, model, test_set, "output/test_task_1.out", pad_idx, True)
print("Complete!")
...
print("Predicting and creating output file for dev set...")
create_op_file(glove_dev_x, y_lstm_dev, model, dev_set, "output/dev_task_2.out", glove_pad, False)
print("Complete!")
...
model.load_state_dict(torch.load('model/blstm2.pt'))
print("Predicting and creating output file for test set...")
create_op_file(glove_test_x, None, model, test_set, "outputs/test_task_2.out", glove_pad, True)
print("Complete!")
